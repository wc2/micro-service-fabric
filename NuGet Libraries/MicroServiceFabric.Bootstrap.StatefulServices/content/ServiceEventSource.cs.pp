...
namespace $rootnamespace$
{
    ...
    internal sealed class ServiceEventSource : EventSource, IStatefulServiceEventSource
    {
        ...
        public ServiceEventSource() : base() { }
        ...
        private void ServiceMessage(string serviceName, string serviceTypeName, long replicaOrInstanceId, Guid partitionId, string applicationName, string applicationTypeName, string nodeName, string message)
        {
